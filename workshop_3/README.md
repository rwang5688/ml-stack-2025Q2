...
[sagemaker_text_generator](sagemaker_text_generator): Enter a prompt. Use a deployed SageMaker JumpStart Inference Endpoint for the Meta Llama 3.2 7B Instruct model to generate a paragraph from the prompt.
...
[bedrock_document_summarizer](bedrock_document_summarizer): Upload a PDF document. Use Anthropic Claude 3 Sonnet and LangChain to generate a summarization of the uploaded document.
