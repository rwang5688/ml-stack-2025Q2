...
def create_env_file():
    ...
    env_content = f"""# SageMaker Multi-Agent System Environment Variables
# Generated by setup_env.py

SAGEMAKER_ENDPOINT_NAME={os.environ.get('SAGEMAKER_ENDPOINT_NAME', '')}
SAGEMAKER_REGION={os.environ.get('SAGEMAKER_REGION', 'us-west-2')}
SAGEMAKER_VERBOSE_LOGGING={os.environ.get('SAGEMAKER_VERBOSE_LOGGING', 'true')}
SAGEMAKER_TIMEOUT={os.environ.get('SAGEMAKER_TIMEOUT', '30')}
SAGEMAKER_MAX_RETRIES={os.environ.get('SAGEMAKER_MAX_RETRIES', '3')}
"""
    
    with open('.env', 'w') as f:
        f.write(env_content)
    
    print("📝 Created .env file for persistent environment variables")
